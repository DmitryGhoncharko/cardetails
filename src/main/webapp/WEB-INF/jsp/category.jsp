        ...
        <div class="col-md-12">
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="row">
                        <div class="col-md-12">
                           <c:forEach var="ct" items="${requestScope.data}">
                               <a href="/controller?command=getCategory&id=${ct.id}">${ct.name}</a>
                                <br/>
                                <br/>
                           </c:forEach>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <a href="/controller?command=newcategory">Создать новую категорию</a>
                        </div>
                    </div>
                </div>
            </div>
