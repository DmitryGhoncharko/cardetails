    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="row">
                <div class="col-md-12">
                    <br>
                    <a class="noprint" href="/controller?command=clearSesSaved">Очистить лист</a>
                    <br>
                    <br>
                    <br>
                    <a class="noprint" href="/controller?command=saveSaved">Сохранить в текущий</a>
                    <br>
                    <br>
                    <form action="/controller?command=saveAnother" method="post">
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="row">
                        <div class="col-md-2">
                            ...
                            <ul id="list">
                                <c:forEach varStatus="index" items="${requestScope.engines}" var="engine">
                                    <li style="display: none"><a href="/controller?command=addSaved&type=engine&id=${engine.id}">${engine.name}</a></li>
                                </c:forEach>
                            </ul>
                            ...
                            <table class="table">
                                ...
                                <c:forEach varStatus="index" items="${sessionScope.engineEntities}" var="engine">
                                    <tr>
                                        <th scope="row">${index.index}</th>
                                        <td>${engine.name}</td>
                                        <td>  <a class="noprint" href="/controller?command=delsessaved&type=engine&id=${engine.id}">Удалить</a></td>
                                    </tr>
                                </c:forEach>
                        ...
                        <div class="col-md-2">
                            ...
                            <ul id="list11">
                                <c:forEach varStatus="index" items="${requestScope.suspensions}" var="engine">
                                    <li style="display: none"><a href="/controller?command=addSaved&type=susp&id=${engine.id}">${engine.name}</a></li>
                                </c:forEach>
                            </ul>
                            <script type="text/javascript">
                                function searchcc() {
                            ...
                            <table class="table">
                                ...
                                <c:forEach varStatus="index" items="${sessionScope.suspensionEntities}" var="engine">
                                    <tr>
                                        <th scope="row">${index.index}</th>
                                        <td>${engine.name}
                                        ...
                                        <td> <a class="noprint" href="/controller?command=delsessaved&type=susp&id=${engine.id}">Удалить</a></td>
                                    </tr>
                                </c:forEach>
                        ...
                        <div class="col-md-2">
                            ...
                            <ul id="list111">
                                <c:forEach varStatus="index" items="${requestScope.bodies}" var="engine">
                                    <li style="display: none"><a href="/controller?command=addSaved&type=body&id=${engine.id}">${engine.name}</a></li>
                                </c:forEach>
                            </ul>
                            <script type="text/javascript">
                                function searchs() {
                            ...
                            <table class="table">
                                ...
                                <c:forEach varStatus="index" items="${sessionScope.bodyEntities}" var="engine">
                                    <tr>
                                        <th scope="row">${index.index}</th>
                                        <td>${engine.name}
                                        </td>
                                        <td>  <a class="noprint" href="/controller?command=delsessaved&type=body&id=${engine.id}">Удалить</a></td>
                                    </tr>
                                </c:forEach>
                        ...
                        <div class="col-md-2">
                            ...
                            <ul id="list1111">
                                <c:forEach varStatus="index" items="${requestScope.salons}" var="engine">
                                    <li style="display: none"><a href="/controller?command=addSaved&type=salon&id=${engine.id}">${engine.name}</a></li>
                                </c:forEach>
                            </ul>
                            <script type="text/javascript">
                                function searchss() {
                            ...
                            <table class="table">
                                ...
                                <c:forEach varStatus="index" items="${sessionScope.salonEntities}" var="engine">
                                    <tr>
                                        <th scope="row">${index.index}</th>
                                        <td>${engine.name}

                                        </td>
                                        <td> <a class="noprint" href="/controller?command=delsessaved&type=salon&id=${engine.id}">Удалить</a></td>
                                    </tr>
                                </c:forEach>
                        ...
                        <div class="col-md-2">
                            ...
                            <ul id="list111111">
                                <c:forEach varStatus="index" items="${requestScope.additions}" var="engine">
                                    <li style="display: none"><a href="/controller?command=addSaved&type=addition&id=${engine.id}">${engine.name}</a></li>
                                </c:forEach>
                            </ul>
                            <script type="text/javascript">
                                function searchv() {
                            ...
                            <table class="table">
                                ...
                                <c:forEach varStatus="index" items="${sessionScope.additionEntities}" var="engine">
                                    <tr>
                                        <th scope="row">${index.index}</th>
                                        <td>${engine.name}
                                        ...
                                        <td>  <a class="noprint" href="/controller?command=delsessaved&type=addition&id=${engine.id}">Удалить</a></td>
                                    </tr>
                                </c:forEach>
                        ...
                        <div class="col-md-2">
                            ...
                            <ul id="list11111">
                                <c:forEach varStatus="index" items="${requestScope.separaters}" var="engine">
                                    <li style="display: none"><a href="/controller?command=addSaved&type=sep&id=${engine.id}">${engine.name}</a></li>
                                </c:forEach>
                            </ul>
                            <script type="text/javascript">
                                function searchz() {
                            ...
                            <table class="table">
                                ...
                                <c:forEach varStatus="index" items="${sessionScope.separaterlyEntities}" var="engine">
                                    <tr>
                                        <th scope="row">${index.index}</th>
                                        <td>${engine.name}
                                        ...
                                        <td>
                                            <a class="noprint" href="/controller?command=delsessaved&type=sep&id=${engine.id}">Удалить</a>
                                        </td>
                                    </tr>
                                </c:forEach>
                        ...
                        <br>
                        <%
                            List<EngineEntity> engineEntities = (List<EngineEntity>) session.getAttribute("engineEntities");
                            List<AdditionEntity> additionEntities = (List<AdditionEntity>) session.getAttribute("additionEntities");
                            List<BodyEntity> bodyEntities = (List<BodyEntity>) session.getAttribute("bodyEntities");
                            List<SalonEntity> salonEntities = (List<SalonEntity>) session.getAttribute("salonEntities");
                            List<SeparaterlyEntity> separaterlyEntities = (List<SeparaterlyEntity>) session.getAttribute("separaterlyEntities");
                            List<SuspensionEntity> suspensionEntities = (List<SuspensionEntity>) session.getAttribute("suspensionEntities");
                            double engineSum = 0;
