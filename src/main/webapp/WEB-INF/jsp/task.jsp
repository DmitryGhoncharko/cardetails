        ...
        <div class="col-md-12">
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="row">
                        <div class="col-md-12">
                            <a href="/controller?command=createNewTask&id=${requestScope.ctId}">Добавить новую таску в категорию</a>
                            <br>
                            <br>
                            <c:forEach var="ts" items="${requestScope.data}">
                                <a href="/controller?command=deleteTask&id=${ts.id}">Удалить</a>
                                <br>
                                <br>
                                <a href="/controller?command=updateTask&id=${ts.id}">Обновить</a>
                                <br>
                                <br>
                                <label for="tsDs">Описание задачи: </label>
                                <p id="tsDs">${ts.desc}</p>
                                <br>
                                <label for="pr">Награда: </label>
                                <h4 id="pr">${ts.price}</h4>
                                <br>
                                <label for="end">Дата окончания: </label>
                                <h4 id="end">${ts.dateEnd}</h4>
                                <br>
                                <br>
