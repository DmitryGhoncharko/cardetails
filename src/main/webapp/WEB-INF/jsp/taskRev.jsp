                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <c:forEach var="dt" items="${requestScope.data}">
                                <label for="tas">Описание задачи: </label>
                                <p id="tas">${dt.task.desc}</p>
                                <br>
                                <a href="${dt.photoUrl}">Посмотреть фото задания</a>
                                <br>
                                <form method="post" action="/controller?command=submit">
                                    <input hidden="" value="${dt.chatId}" name="chatId">
                                    <input hidden="" value="${dt.task.id}" name="taskId">
                                    <label for="dd">Ответ пользователю:</label>
                                    <input type="text" name="text" id="dd" size="300px">
                                    <br>
