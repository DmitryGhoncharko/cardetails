        ...
        <div class="col-md-12">
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="row">
                        <div class="col-md-12">
                            <form method="post" action="/controller?command=updateCategory">
                                <input hidden="hidden" name="id" value="${requestScope.data.id}">
                                <br>
                                <label for="name">Название категории: </label>
                                <input type="text" value="${requestScope.data.name}" id="name" name="name">
                                <br>
                                <br>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <br/>
                            <br/>
                            <a href="/controller?command=taskByCategory&id=${requestScope.data.id}">Посмотреть задания в категории</a>
                        </div>
                    </div>
                </div>
            </div>
