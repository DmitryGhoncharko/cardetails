        ...
        <div class="col-md-12">
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="row">
                        <div class="col-md-12">
                            <form method="post" action="/controller?command=updatetaskk">
                                <input hidden="hidden" name="id" value="${requestScope.data.id}">
                                <label for="desc">Описание: </label>
                                <input type="text" id="desc" name="desc" value="${requestScope.data.desc}" style="width: 400px; height: 400px">
                                <br>
                                <label for="price">Награда: </label>
                                <input name="price" type="number" id="price" value="${requestScope.data.price}">
                                <br>
                                <label for="date">Дата окончания: </label>
                                <input id="date" type="date" name="date" value="${requestScope.data.dateEnd}">
                                <br>
